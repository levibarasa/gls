...
public class GroupsTableMod  implements java.io.Serializable {
    ...
    public GroupsTableMod(int modId, String bankId, String branchName, String countryCode, String delFlg, Date firstMeetDate, Date formationDate, String gpRegion, String gpStatus, String gpStatusCode, String groupAddress, String groupCenter, String groupCode, int groupId, double groupLoans, String groupName, String groupPhone, String groupVillage, String grpMgrId, String grpRegNo, String lastOper, Date lchgDate, String lchgUserId, int loanAccounts, int maxAllowedMembers, int maxAllowedSubGrps, String meetFrequency, String meetPlace, int noOfMembers, int noOfSubGrps, Date nxtMeetDate, double outstandingBal, Date rcreTime, String rcreUserId, int savingAccounts, double savingsAmt, int solId) {
        this.modId = modId;
        this.bankId = bankId;
    ...
    public GroupsTableMod(int modId, String bankId, String branchName, String countryCode, String delFlg, Date firstMeetDate, Date formationDate, String gpChair, String gpRegion, String gpSecretary, String gpStatus, String gpStatusCode, String gpTreasurer, String groupAddress, String groupCenter, String groupCode, int groupId, double groupLoans, String groupName, String groupPhone, String groupVillage, String grpMgrId, String grpRegNo, String lastOper, Date lchgDate, String lchgUserId, int loanAccounts, int maxAllowedMembers, int maxAllowedSubGrps, String meetFrequency, String meetPlace, String meetTime, int noOfMembers, int noOfSubGrps, Date nxtMeetDate, double outstandingBal, Date rcreTime, String rcreUserId, int savingAccounts, double savingsAmt, int solId) {
       this.modId = modId;
       this.bankId = bankId;
       this.branchName = branchName;
       this.countryCode = countryCode;
