...
public class Resources  implements java.io.Serializable {
    ...
    public Resources(int resId, String mopId, String mopText, String mopUrl, Date rcreTime, String rcreUser) {
       this.resId = resId;
       this.mopId = mopId;
    ...
    @Column(name="RES_ID", unique=true, nullable=false, precision=10, scale=0)
    public int getResId() {
        return this.resId;
    }
