...
public class SubGrpTable  implements java.io.Serializable {
    ...
    public SubGrpTable(String bankId, String branchName, String countryCode, String delFlg, Date firstMeetDate, Date formationDate, int groupId, Date lchgDate, String lchgUserId, int loanAccounts, int maxAllowedMembers, String meetFrequency, String meetPlace, String meetTime, int noOfMembers, Date nxtMeetDate, double outstandingBal, Date rcreTime, String rcreUserId, int savingAccounts, double savingsAmt, int solId, String subGpChair, String subGpRegion, String subGpSecretary, String subGpStatus, String subGpStatusCode, String subGpTreasurer, String subGroupAddress, String subGroupCenter, String subGroupCode, double subGroupLoans, String subGroupName, String subGroupPhone, String subGroupVillage, String subGrpMgrId, String subGrpRegNo) {
       this.bankId = bankId;
       this.branchName = branchName;
       this.countryCode = countryCode;
       this.delFlg = delFlg;
    ...
    @Column(name="SUB_GROUP_ID", unique=true, nullable=false, precision=10, scale=0)
