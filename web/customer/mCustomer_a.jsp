<head>
    ...
    <script type="text/javascript">
        ...
        function getFunctionValue() {
            popup = window.open("customer/function.jsp", "Functions", "width=500,height=400");
            popup.focus();
            return false;
        }
    </script>
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=gomcustomer" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="left" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Accounts Mapping Maintenance</div></th>
        </tr>
        <tr>
