<head>
    ...
    <script type="text/javascript">
        ...
        function getFunctionValue() {
            popup = window.open("group/function.jsp", "Functions", "width=500,height=400");
            popup.focus();
            return false;
        }
        function getValue() {
            popup = window.open("group/grouptypepop.jsp", "Functions", "width=500,height=400");
            popup.focus();
            return false;
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=gomgroup" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="left" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Group Register Maintenance</div></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="color: red">*</td>
            <td><label>
                    <input name="grouptype"  type="text" id="grouptype" readonly="true" onkeyup="this.value = this.value.toUpperCase();" class="textboxes" />
                </label></td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td><label>
                    <input name="Submit" class="redButton" type="submit" onclick="MM_validateForm('function', '', 'R', 'grouptype', '', 'R');
