...
<html>
    <%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
             java.util.*" errorPage="" %>
    <%
        ArrayList all = Category.getCategories("REGION");
        int size = all.size();
    %>	
    <head>
        <style type="text/css">
        ...
        <script type="text/javascript">
            function getRegionValue(ths) {
                if (window.opener !== null && !window.opener.closed) {
                    var func = window.opener.document.getElementById("region");
    ...
    <form id="popup">
        <table width="95%" align="center"  style="border:#013567 solid 2px;padding:10px;" border="0">
            <tr>
                <th bgcolor="#00C3F9" scope="col"><span class="style10">Region Name</span></th>
                <th bgcolor="#00C3F9" scope="col"><span class="style10">Region Code</span></th>
            ...
            <tr style="height:30px; padding:4px;">
                <td><div align="center"><a href="" onclick="getRegionValue(this)" id="cname"><%=(String) one.get(2)%></a></div></td>
