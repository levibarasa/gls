                    ...
                    <link href="include/main.css" rel="stylesheet" type="text/css">
                        <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
                            ...
                            <style>
                                ...
                                .style4 {color: #FF9E4D}
                                .style5 {color: #5757D9}
                                .style6 {color: #5757D9; font-weight: bold; }
                            </style>
                            ...
                            <body>
                                <div class="myBox">
                                    <table width="" border="0"  align="center" style=" background:#FF9E4D">
                                        <tr>
                                        ...
                                        <tr>
                                            <th colspan="3" bgcolor="#5757D9" scope="col"><div align="center"><span class="style3"><span class="style4">Group Lending System</span></span> </div></th>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td><form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doLog">
                                                    <table width="100%" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td rowspan="8"><img src="images/Logo.png" width="220" height="80" /></td>
                                                            <td colspan="2">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="footertext">
                                        <p align="center">Copyright 2002 - 2020 - <b>Simbatech.biz</b> - All Rights Reserved <br>
                                                <br>
