...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=domwcrp" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="center" cellpadding="5" cellspacing="2">
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="setup" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="product" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="order" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="supply" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="request" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="delivery" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
        <tr>
        ...
        <tr>
            ...
            %>
            <td><%= (String) one.get(1)%></td>
            <td><input type="checkbox" name="invoice" value="<%= (String) one.get(1)%>" /></td>
                <% }%>
        </tr>
    </table>
    <table width="70%" border="0" align="center" cellpadding="5" cellspacing="2">
