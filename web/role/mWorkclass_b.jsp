<head>
    ...
    <script type="text/javascript">
        ...
        function getValue() {
            ...
            if (func === "VERIFY") {
                popup = window.open("role/wcpop_ver.jsp", "Workclasses", "width=500,height=400");
            } else {
                popup = window.open("role/wcpop.jsp", "Workclasses", "width=500,height=400");
            }
            if(func === "ADD"){
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=gomrole" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="center" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Role Profile Maintenance second</div></th>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
            <td width="27%">&nbsp;</td>
        ...
        <tr>
            ...
            <td style="color: red">*</td>
            <td><label>
                    <input name="rolename"  type="text" id="rolename" onkeyup="this.value = this.value.toUpperCase();" class="textboxes" />
                </label></td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td><label>
                    <input name="Submit" class="redButton" type="submit" onclick="MM_validateForm('function', '', 'R', 'rolename', '', 'R');
