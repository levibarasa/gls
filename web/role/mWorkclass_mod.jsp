<head>
    ...
    <script type="text/javascript">
        var popup;
        function getValue() {
            popup = window.open("workclass/wcpop.jsp", "Workclasses", "width=500,height=400");
            popup.focus();
            return false;
        }
    </script>
...
<h2 style="font: bold 90% 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size: 16px">Work Class Modifications</h2>
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=domodwc" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="center" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Work Class Maintenance</div></th>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
            <td width="27%">&nbsp;</td>
        ...
        <tr>
            ...
            <td><label>
                    <input name="workclass" type="text" value="${mclassn}" id="workclass" onkeyup="caps(this)" class="textboxes" />
                </label></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            ...
            <td style="color: red">*</td>
            <td><label>
                    <input name="workc" type="text" value="${mworkc}" id="workc" onkeyup="caps(this)" class="textboxes" />
                </label></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
